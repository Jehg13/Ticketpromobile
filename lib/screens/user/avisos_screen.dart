...
class _AvisosScreenState extends State<AvisosScreen> {
  ...
  Future<void> _cargarAvisos({
    ...
    try {
      ...
      final respuesta = await AvisosusuarioService.obtenerAvisos(
      ...
      final lista = _convertirListaMap(
        respuesta['avisos'],
      );

      final totalRespuesta = respuesta['total'];

      final total = totalRespuesta != null
          ? _enteroSeguro(totalRespuesta)
          : lista.length;
  ...
  String _afectaAviso(
    ...
    final afectaTexto = _textoSeguro(
      aviso['afecta_texto'],
    );
    ...
    final afectaDirecto = _textoSeguro(
      aviso['afecta'],
    );
  ...
  String _archivoAviso(
    Map<String, dynamic> aviso,
  ) {
    final archivo = _textoSeguro(
      aviso['archivo'],
    );
  ...
  bool _esImagen(
    ...
    return extensiones.contains(
      _extensionArchivo(ruta),
    );
  }
  ...
  String _urlArchivo(
    ...
    return AvisosusuarioService.obtenerArchivoUrl(
          aviso,
        ) ??
        '';
  }
  ...
  Future<void> _abrirArchivo(
    ...
    if (url.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Este aviso no tiene un archivo válido.',
          ),
        ),
      );
    ...
    if (uri == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'La dirección del archivo no es válida.',
          ),
        ),
      );
  ...
  void _mostrarDetalle(
    ...
    final esImagen = _esImagen(
      archivo.isNotEmpty ? archivo : urlArchivo,
    );
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (tieneArchivo) ...[
                    ...
                    if (esImagen)
                      _buildVistaPreviaImagen(
                        urlArchivo,
                      )
                    else
                      _buildArchivoAdjunto(
                        aviso,
                        archivo.isNotEmpty
                            ? archivo
                            : urlArchivo,
  ...
  Widget _buildVistaPreviaImagen(
    String url,
  ) {
    return ClipRRect(
  ...
  Widget build(
    ...
    return Scaffold(
      ...
      drawer: isDesktop
          ? null
          : const home.AppNavigationDrawer(),
      body: Row(
        children: [
          if (isDesktop)
            const SizedBox(
              width: 260,
              child: home.AppNavigationDrawer(),
            ),
          Expanded(
            child: SafeArea(
  ...
  Widget _buildFilterAndSearch(
    ...
    final filtros = [
      ...
      },
      {
        ...
        'background': const Color(0xFF38240D),
      },
      {
        'label': 'Falla / Incidente',
        'color': const Color(0xFFEF4444),
        'background': const Color(0xFF3B1219),
      },
      {
        'label': 'Informativo',
        'color': const Color(0xFF06B6D4),
        'background': const Color(0xFF0C2A3A),
      },
      {
        'label': 'General',
        'color': Colors.grey,
    ...
    final filtroWidget =
      ...
      child: Row(
        children: filtros.map((filtro) {
          final label =
              filtro['label'] as String;
          final color =
              filtro['color'] as Color;
          final background =
              filtro['background'] as Color;
          final seleccionado =
        ...
        children: [
          ...
          Text(
            tieneBusqueda
                ...
                : 'Actualmente no existen avisos dirigidos a ti.',
  ...
  Widget _buildPagination(
    ...
    final paginas =
        _paginasVisibles(totalPaginas);

    final pageInfo = Text(
      'Mostrando $_primerAvisoMostrado a $_ultimoAvisoMostrado de $totalAvisos avisos',
      style: const TextStyle(
        color: Colors.grey,
        fontSize: 12,
      ),
